...
def foo():
    code = "OUT20230727172122344"
    customer_list = Outorder.objects.filter(code=code)
    ...
    #     for i in obj:
    #         print(i)
    customer_list = Outorder.objects.filter(code=code).values('id', 'outorder__outorderclothes__amount', 'outorder__clothes__name','outorder__clothes__price')
    #print(customer_list)
    d = {}
