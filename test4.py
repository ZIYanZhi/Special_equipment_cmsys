...
def foo():
    ...
    #     for i in obj:
    #         print(i)
    customer_list = Customer.objects.filter(address=address).values('id', 'outorder__outorderclothes__amount', 'outorder__clothes__name','outorder__clothes__price','outorder__clothes__create_time')
    print(customer_list)
    d = {}
    for item in customer_list:
        ...
        d['create_time'] = item['outorder__clothes__create_time']

    print("机件名",d['outorder__clothes__name'] ,"数量",d['amount'],"价格",d['price'],"元",d['create_time'])
